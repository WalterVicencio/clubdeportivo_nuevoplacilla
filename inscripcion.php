...
<body>
    ...
    <form method="post" action="./inscripcion_basica.php">
            ...
            <section>
                <div>
                    <p>Nombres</p>
                    <input name="a_nombre" type="text" required>
                </div>
                <div>
                    <p>Apellidos</p>
                    <input name="a_apellido" type="text">
                </div>
                <div>
                    <p>Fecha Nacimiento</p>
                    <input id="a_fnac" name="03" type="date" required>
                </div>
                <div>
                    <p>Edad</p>
                    <input style="text-align: center; background-color: rgba(255,255,255,0.5);" id="a_edad" name="a_edad" type="text" required readonly>
                </div>
                <div>
                    <p>Edad</p>
                    <input style="text-align: center; background-color: rgba(255,255,255,0.5);" id="a_edad" name="a_edad" type="text" required readonly>
