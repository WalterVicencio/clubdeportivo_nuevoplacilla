...
fecha_nacimiento=document.querySelector("#a_fnac");


document.getElementById('a_fnac').addEventListener('change',()=>{
    var fecha=this.value;
    cumple= new Date(document.getElementById('a_fnac').value);
    ...
    document.getElementById('a_edad').value=eda;
})
